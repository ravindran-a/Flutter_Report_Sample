...
class ReportsRoyaltyFailedScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ReportsRoyaltyFailedScreen();
  }
}

class _ReportsRoyaltyFailedScreen extends State<ReportsRoyaltyFailedScreen> {
